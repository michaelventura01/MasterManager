<?php if(!$_SESSION['nombre']==""&&!$_SESSION['tipo']==""){
  ...
  if(isset($_POST['name_complete_update']) && isset($_POST['old_user_update']) && isset($_POST['new_user_update']) && isset($_POST['old_pass_update']) && isset($_POST['new_pass_update'])){
    ...
    if(mysqli_num_rows($sql)>=1){
      MysqlQuery::Actualizar("usuario", "nombre_completo='$nombre_complete_update', nombre_usuario='$new_user_update', email_usuario='$email_update', telefono_usuario='$telefono_update', clave='$new_pass_update'", "nombre_usuario='$old_user_update' and clave='$old_pass_update'");
  ...
  <div class="container">
    <div class="row well">
      ...
      <div class="col-sm-9 lead">
        <h2 class="text-info">Bienvenido a la configuración de cuenta Master Manager</h2>
        <p>Puedes <strong>actualizar los datos</strong> de tu cuenta ó puedes <strong>eliminar tu cuenta</strong> permanentemente si ya no deseas ser usuario de Master Manager</p>
      </div>
    </div><!--Fin row well-->
        ...
        <div class="panel panel-info">
          ...
          <div class="panel-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control"  placeholder="Escriba su número teléfonico" name="telefono_update" required="">
              </div>
