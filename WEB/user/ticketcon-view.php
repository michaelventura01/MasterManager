...
?>
    <div class="container">
        ...
        <div class="col-sm-10 lead text-justify">
            <h2 class="text-info">Estado de solicitud de soporte</h2>
            <p>Si su <strong>Solicitud</strong> no ha sido atendida aún, por favor espere pacientemente.</p>
        </div>
        </div><!--fin row well-->
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        <div class="container">
                            <div class="col-sm-12">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <img class="img-responsive" alt="Image" src="img/mm.png">
                                    </div>
                                    <div class="col-sm-8">
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6"><strong>Email:</strong> <?php echo $lsT['email_usuario']; ?></div>
                                        </div>
                                        <br>
                                        <div class="row">
                                            <div class="col-sm-6"><strong>Tipo de Documento:</strong> <?php echo $lsT['documentType']; ?></div>
                                            <div class="col-sm-6"><strong>Asunto:</strong> <?php echo $lsT['asunto']; ?></div>
                                        </div>
                                        <br>
                                        <div class="row">
                                            <div class="col-sm-6"><strong>Anexo:</strong> <?php echo $lsT['anexo']; ?></div>
                                            <div class="col-sm-6"><strong>descripción:</strong> <?php echo $lsT['mensaje']; ?></div>
                                        </div>
                                        <br>
                                        <div class="row">
                                            <div class="col-sm-12"><strong>Reporte:</strong> <?php echo $lsT['solucion']; ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="panel-footer text-center">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <button id="save" class="btn btn-success" data-id="<?php echo $lsT['serie']; ?>"><span class="glyphicon glyphicon-floppy-disk"></span>&nbsp; Descargar PDF</button>
                            </div>
                        </div>
                    </div>
                </div>
